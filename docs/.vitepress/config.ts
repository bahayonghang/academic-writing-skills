  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Journal Abbreviations', link: `${r}/citations/journal-abbreviations` },
        { text: 'Journal Adaptation', link: `${r}/venues/journal-adaptation-workflow` },
        { text: 'Number & Unit Guide', link: `${r}/formatting/number-unit-guide` },
        { text: 'Reviewer Perspective', link: `${r}/review/reviewer-perspective` },
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Introduction', link: `${r}/writing/section-writing/introduction` },
        { text: 'Related Work', link: `${r}/writing/section-writing/related-work` },
        { text: 'Method', link: `${r}/writing/section-writing/method` },
        { text: 'Experiments', link: `${r}/writing/section-writing/experiments` },
        { text: 'Conclusion', link: `${r}/writing/section-writing/conclusion` },
        { text: 'Flow', link: `${r}/writing/section-writing/flow` },
        { text: 'Self Review', link: `${r}/writing/section-writing/self-review` },
      ],
    },
  ]
}
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Table Guide', link: `${r}/formatting/table-guide` },
        { text: 'Thesis Writing Guide', link: `${r}/writing/thesis-writing-guide` },
        { text: 'Title Optimization', link: `${r}/writing/title-optimization` },
        { text: 'Writing Philosophy', link: `${r}/writing/writing-philosophy-zh` },
      ],
    },
    {
