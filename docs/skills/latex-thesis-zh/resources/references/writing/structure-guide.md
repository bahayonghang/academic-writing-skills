...
- The **Chapter Introduction** of each chapter of the main text (Chapter 2 to the conclusion) should connect the preceding and following content; either one-paragraph or two-paragraph form is acceptable, about 300~600 words: when dependencies exist, use chapter numbers ("Chapter X") to connect to the prior chapter, and state this chapter's problem, approach, and section arrangements; avoid relative references like "previous chapter/above". See the "Chapter Introduction" section of [`thesis-writing-guide.md`](thesis-writing-guide.md) for details.
