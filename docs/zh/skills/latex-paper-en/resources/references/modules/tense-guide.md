...
居住在 [over-claim-guard.md](../evidence/over-claim-guard.md)。
- 超越时态的表面语法存在于 [grammar.md](grammar.md) 中。

## 脚本支持

`deai_check.py`将方法/结果中的现在时报告动词标记为`[Script]`
低迹线（配置：`tense:`在`references/deai/tone-thresholds.yaml`, 切换
