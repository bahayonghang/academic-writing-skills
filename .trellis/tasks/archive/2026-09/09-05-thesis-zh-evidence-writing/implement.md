...
```powershell
uv run --extra dev python -m pytest tests/contracts/test_skill_contracts.py tests/contracts/test_trigger_evals.py tests/contracts/test_defensive_ai_rhetoric_contract.py tests/contracts/test_claim_evidence_contract.py tests/skills/latex_thesis_zh/test_abstract_thesis_mode.py tests/skills/latex_thesis_zh/test_chapter_intro_forms.py tests/skills/latex_thesis_zh/test_results_analysis.py -q
