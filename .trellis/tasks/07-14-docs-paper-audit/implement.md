...
```powershell
rtk uv run python docs/scripts/check_resource_sync.py --skill paper-audit
...
- `check_resource_sync.py --skill paper-audit`: passed, 250-entry manifest loaded.
...
- High-risk bilingual samples reviewed: workflow detail, deep-review criteria, issue schema,
  editor-in-chief, committee editor, and lane agent contracts.
