...
- 不修改 `academic-writing-skills/latex-thesis-zh/` 下的技能源文件。

## Acceptance Criteria

- [ ] 当前 48 个源资源均有规范英文页和中文页；无漏项、多余项或旧路径残留。
...
- [ ] 对 `references/modules/routing-rules.md`、abstract/conclusion modules、四个 chapter guide、GB standard、thuthesis/yanshan templates 完成逐段双语抽样复核。
