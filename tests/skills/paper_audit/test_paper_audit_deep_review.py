...
from tests.support.paths import SCRIPT_DIR_AUDIT, SKILLS_ROOT
...
_AGENTS_DIR = SKILLS_ROOT / "paper-audit" / "agents"
_REFS_DIR = SKILLS_ROOT / "paper-audit" / "references"
...
def test_verify_quotes_cli_write_back_demotes_missing_quotes(tmp_path) -> None:
    ...
    script = SCRIPT_DIR_AUDIT / "verify_quotes.py"
...
def test_critical_reviewer_agent_documents_surrender_protocol() -> None:
    agent_path = SKILLS_ROOT / "paper-audit" / "agents" / "critical_reviewer_agent.md"
