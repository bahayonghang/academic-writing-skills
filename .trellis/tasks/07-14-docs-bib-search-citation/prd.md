...
- [ ] 当前 6 个源资源均有规范英文页和中文页；无漏项、多余项或旧路径残留。
- [ ] 两种语言的概览模块/模式、命令、输入和输出逐项对应当前 `SKILL.md`。
- [ ] `check_resource_sync.py --skill bib-search-citation` 通过。
- [ ] 标题层级、代码块、inline 技术 token、表格结构和相对链接检查通过。
- [ ] 对 `references/query-syntax.md`、`references/limitations-and-errors.md`、`examples/raw-bib-export.md` 完成逐段双语抽样复核。
