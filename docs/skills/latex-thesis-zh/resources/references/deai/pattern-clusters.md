# Evidence-Aware De-AI Pattern Clusters for Chinese Theses

> Pattern lineage: Wikipedia's community-maintained “Signs of AI writing” guidance and
> general-purpose humanizer prior art, adapted here for academic evidence preservation. These
> patterns are review prompts, not AI-authorship detection rules.

## Purpose And Automation Boundary

Load this reference after the core de-AI guide when visible prose still contains low-information
...
anchor. Do not flag text merely because it contains Chinese words equivalent to “highlight,”
“ensure,” “reflect,” or “indicate.”
...
**Repair**: state the observable property and evidence anchor. If neither exists, mark it as
【待补证】 rather than supplying a number, baseline, or source.

## H-ATTR: Vague Attribution

**Flag when** readers cannot identify who made a claim, which source supports it, or what scope the
attribution covers, such as an uncited “experts argue.”

**Keep when** the author or institution is named, the citation resolves, and the attributed claim
has a clear boundary. A truthful statement that evidence is limited is also a valid limitation.
...
**Flag when** constructions equivalent to “serves as,” “represents,” or “marks” merely lengthen a
simple predicate without adding a technical relation. For example, “Table 2 serves as a presentation
of the results” can become “Table 2 presents the results.”
...
**Repair**: narrow the scope to what the thesis actually covers. Never manufacture a fourth item or
...
withdraws those mechanisms. An honest statement that the mechanism remains undetermined is not
H-OUTLOOK.
