...
SKILL_DIR = Path(__file__).parent.parent / "academic-writing-skills" / "bib-search-citation"
...
FIXTURE_BIB = SKILL_DIR / "tests" / "fixtures" / "library.bib"
PREVIEW_INPUT = SKILL_DIR / "tests" / "fixtures" / "preview_input.json"
