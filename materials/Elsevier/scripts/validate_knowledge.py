"""Validate Elsevier knowledge-pack TSV headers and inventory alignment."""
...
OBSERVATIONS_DIR = ELS_ROOT / "observations"
KNOWLEDGE_DIR = ELS_ROOT / "knowledge"
EXPECTED_COUNT = 150
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate Elsevier knowledge pack")
    parser.add_argument(
        "--allow-pending",
        action="store_true",
