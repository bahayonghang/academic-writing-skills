...
description: >-
  This skill should be used when the user asks to "帮我编译论文", "检查国标格式", "看看绪论逻辑", "文献综述太像罗列",
  "研究空白没推出来", "毕业论文", "学位论文", "硕士论文", "博士论文", "三线表", "检查摘要", "摘要结构", "编译论文", or works on a
  Chinese .tex master's/doctoral thesis needing XeLaTeX/LuaLaTeX compilation, GB/T 7714
  bibliography checks, or template support (thuthesis, pkuthss).
metadata:
