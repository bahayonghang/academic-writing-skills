...
```powershell
rtk uv run python docs/scripts/check_resource_sync.py --skill latex-paper-en
...
- `check_resource_sync.py --skill latex-paper-en`: passed, 250-entry manifest loaded.
...
- High-risk bilingual samples reviewed: routing rules, introduction/method/conclusion guides,
  de-AI guide, and IEEE template.
