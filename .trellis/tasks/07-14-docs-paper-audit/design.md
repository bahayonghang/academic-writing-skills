...
本任务只拥有 `docs/skills/paper-audit/`、`docs/zh/skills/paper-audit/` 及对应 manifest 行。
...
至少复核 `references/workflow-detail.md`、`references/DEEP_REVIEW_CRITERIA.md`、`references/ISSUE_SCHEMA.md`、editor-in-chief/committee/lane agent 说明，覆盖规范性规则、操作流程和示例三类内容。检查 MUST/禁止、
