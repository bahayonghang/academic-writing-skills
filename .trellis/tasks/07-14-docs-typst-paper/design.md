...
本任务只拥有 `docs/skills/typst-paper/`、`docs/zh/skills/typst-paper/` 及对应 manifest 行。
...
至少复核 `references/skill-routing-notes.md`、`references/TYPST_SYNTAX.md`、PSEUDOCODE/REFERENCES/DEAI modules、IEEE template，覆盖规范性规则、操作流程和示例三类内容。检查 MUST/禁止、
